...
def write_content(resources_folder):
    ...
    *Purush*. Once  all *Purush* are awakened, the *Prakriti*’s work is complete and it
    ...
    nature called *Sukshm*. It is *Sukshm* that gets tinged with the acquired 
    ...
    *Bhavas* your current position in this karmic journey of many lives until *Moksha*. 
    A score of 11/13 means you are very near to achieving the awakening state.  
    A score of 7/13 means you are ahead but can speed it up by certain lifestyle changes.      
